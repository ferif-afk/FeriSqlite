...
class DatabaseHandler(context: Context):
    ...
    companion object {
        ...
        private val DATABASE_NAME = "Employeet"
        private val TABLE_CONTACTS = "EmployeeTB"
        private val KEY_ID = "id"
        private val KEY_NAME = "name"
        private val KEY_EMAIL = "email"
        private val KEY_TEMPAT = "tempat"
    }
    ...
    fun addEmployee(emp: EmpModelClass):Long{
        ...
        contentValues.put(KEY_TEMPAT, emp.userTempat )
    ...
    fun viewEmployee():List<EmpModelClass>{
        ...
        var userTempat: String
        if (cursor.moveToFirst()) {
            do {
                userId = cursor.getInt(cursor.getColumnIndex("id"))
                userName = cursor.getString(cursor.getColumnIndex("name"))
                userEmail = cursor.getString(cursor.getColumnIndex("email"))
                userTempat = cursor.getString(cursor.getColumnIndex("tempat"))
                val emp = EmpModelClass(userId = userId, userName = userName, userEmail = userEmail, userTempat = userTempat )
                empList.add(emp)
